...
export default function Navbar() {
  ...
  const isFocusPage = location.pathname === '/diagnostico' || location.pathname === '/resultado-diagnostico' || location.pathname.startsWith('/arcade') || location.pathname === '/diegobet';
