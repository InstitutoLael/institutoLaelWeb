  ...
  return (
    <div className="w-full max-w-4xl mx-auto py-24 px-6">
      <div className="text-center mb-16">
        ...
        <h2 className="font-display text-4xl lg:text-5xl text-lael-primary font-bold">Hablemos claro.</h2>
      </div>
      ...
      <div className="space-y-4">
        {FAQS.map((faq, i) => (
          <div key={i} className="border-b border-lael-bd">
            ...
            >
              <h3 className={`font-display text-xl lg:text-2xl transition-colors duration-300 ${openIndex === i ? 'text-lael-accent' : 'text-lael-primary group-hover:text-lael-accent/70'}`}>
                {faq.q}
              </h3>
