import { Pago, Reloj, Diagnostico } from '../components/icons/LaelIcons';

export const FAQ_DATA = [
  {
    category: "Precios y becas",
    icon: Pago,
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Tengo un horario difícil, ¿puedo entrar?", a: "Sí. Las clases son en vivo por Google Meet, desde las 18:00, y se graban: cada semana te compartimos las grabaciones por si un día no alcanzas a conectarte. Así puedes combinarlas con el colegio o el trabajo." }
    ]
  },
  {
    category: "Cómo son las clases",
    icon: Diagnostico,
    items: [
