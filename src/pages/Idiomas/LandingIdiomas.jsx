        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {LANG_FEATURES.map((f, i) => (
              <motion.div key={f.title} {...fadeUp(i * 0.1)} className="p-8 rounded-2xl bg-[#080808] hover-card">
        ...
        <div className="w-full max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {LANGUAGES.map((lang, i) => (
              <motion.div key={lang.id} {...fadeUp(i * 0.1)} className="p-8 rounded-2xl bg-[#080808] hover-card">
