...
export default function Nosotros() {
  return (
    <section className="about">
      ...
      {/* IDENTIDAD */}
      <section className="section band band--id">
      ...
      {/* EVOLUCIÓN */}
      <section className="section band band--evo">
        <div className="container">
          ...
          <div className="hl-flow">
            ...
            <FlowItem title="Instituto Lael">
              Trayectorias por competencias y programas para personas y
              empresas.
            </FlowItem>
          </div>
        </div>
...
function Pillar({ img, t, s }) {
  return (
    <article className="pillar card pp">
...
.btn{padding:.75rem 1.15rem;border-radius:12px;border:2px solid transparent;text-decoration:none;font-weight:850;display:inline-flex;align-items:center;justify-content:center}
...
/* Tarjetas */
.card{border:1px solid #243153;border-radius:16px;background:linear-gradient(180deg,#0f172a,#0b1220);color:var(--ink)}
.pad{padding:16px}
...
.band.band--id{
  background:radial-gradient(900px 340px at 8% -12%,rgba(59,84,157,.24),transparent 60%),
             radial-gradient(900px 300px at 92% -10%,rgba(36,149,84,.20),transparent 60%),
             linear-gradient(180deg,#0b1220,#0e1526);
}
.band.band--evo{
  background:radial-gradient(900px 340px at 12% -14%,rgba(157,59,105,.18),transparent 60%),
             radial-gradient(900px 300px at 88% -10%,rgba(250,204,21,.12),transparent 60%),
             linear-gradient(180deg,#0e1526,#0b1220);
}
...
.id.card .media{height:clamp(180px,28vw,260px);padding:12px;display:grid;place-items:center;background:#0b1220;border-bottom:1px solid #22314f;}
.id.card .media img{width:100%;height:100%;object-fit:contain;object-position:center;filter:drop-shadow(0 6px 14px rgba(16,24,40,.35));}
.id.card .body{padding:18px;}
.id.card .body h3{margin:.2rem 0 .35rem;}
.id.card .body p{margin:0;color:var(--ink2);}

/* Flow */
.hl-flow{display:grid;grid-template-columns:1fr auto 1fr auto 1fr;gap:14px;align-items:stretch;margin-top:18px;}
@media (max-width:980px){.hl-flow{grid-template-columns:1fr}.flow-arrow{display:none}}
.flow-item{border:1px solid #22314f;border-radius:16px;background:linear-gradient(180deg,#0f172a,#0b1220);padding:16px;box-shadow:0 18px 36px rgba(2,6,23,.38);}
.flow-title{font-weight:800;margin:0 0 6px;}
.flow-text{margin:0;color:var(--ink2);}
.flow-arrow{display:grid;place-items:center;font-weight:900;font-size:1.6rem;color:var(--ink);}
...
.cta-panel{text-align:center;border:1px solid #22314f;border-radius:20px;padding:26px;
