...
export default function EliteLayer() {
  return (
    <section id="activacion-layer" className="w-full px-6 py-32 lg:py-48 min-h-screen flex flex-col items-center justify-center border-t border-lael-bd">
      <div className="w-full max-w-4xl text-center relative z-10">
        <p className="text-lael-accent text-[11px] tracking-[0.4em] uppercase mb-8 font-bold">Nivel Avanzado</p>
        ...
        <button className="bg-transparent border border-lael-accent text-lael-accent px-10 py-5 rounded-lg text-[10px] lg:text-[11px] tracking-[0.2em] uppercase font-bold hover:bg-lael-accent/5 transition-all duration-500 shadow-sm">
