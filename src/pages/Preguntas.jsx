...
const FAQ_DATA = [
  {
    ...
    items: [
      { q: "¿Por qué la PAES es tan accesible en Lael?", a: "Porque creemos que el talento no tiene estrato social. El plan mensual es $9.990 — una fracción de lo que cobra un preuniversitario tradicional — y si no lo puedes cubrir, puedes postular a una beca. La meta es que el dinero nunca sea la razón por la que alguien se queda fuera." },
      { q: "¿Hay algún costo oculto o matrícula?", a: "No hay costos ocultos. La matrícula es gratis; el único cobro es el plan mensual ($9.990), sin cargos extra por materiales." }
    ]
  },
  {
